  ...
  return (
    <div className="h-auto w-full px-3 py-4">
      <div className="relative">
        <section className="h-[150vh] w-full rounded-xl bg-pink-200 px-28">
        ...
        <div className="absolute left-1/2 top-1/2 z-10 h-[1000px] w-[1100px] -translate-x-1/2 -translate-y-[45%]">
          <Image
            src="/billboard.webp"
            alt="Billboard Image"
            fill
